        ...
        <div className='h-[74px] w-[81%] mx-auto max-[1247px]:w-full'>
            <header className='flex justify-around items-center h-full max-[1247px]:justify-between max-[1247px]:mx-5 max-[700px]:justify-center'>
                ...
                <div className='max-[700px]:hidden'>
                    <ul className='flex'>
                        ...
                        <NavLink to="/activity" className='hover:bg-[#F5F5F5] dark:hover:bg-[#1C1C1C] py-[20px] px-[32px] rounded-md my-[4px] mx-[2px] transition-all duration-500 cursor-pointer active:scale-90'>
                        ...
                        <NavLink to="/profile" className='hover:bg-[#F5F5F5] dark:hover:bg-[#1C1C1C] py-[20px] px-[32px] rounded-md my-[4px] mx-[2px] transition-all duration-500 cursor-pointer active:scale-90'>
                ...
                <div className='fixed bottom-8 left-10 hover:scale-105 duration-200 cursor-pointer flex w-[40%] justify-center max-[700px]:justify-center max-[700px]:left-0 max-[700px]:flex max-[700px]:w-full max-[700px]:bottom-24 z-10'>
                    <div className='flex items-center gap-2 rounded-full px-6 py-4 font-semibold text-sm border-[1px] border-gray-100 shadow-md bg-white dark:bg-[#181818] dark:text-white dark:border-[#999999] dark:border-opacity-10 border-opacity-10' onClick={changePostStatus}>
                ...
                {/* bottonav */}
                <nav className='hidden max-[700px]:block fixed bottom-0 left-0 w-full bg-white dark:bg-[#101010] z-10 opacity-95'>
                    <ul className='flex justify-around'>
                        <NavLink to="/" className='hover:bg-[#F5F5F5] py-5 px-8 rounded-md my-[4px] mx-[2px] transition-all duration-500 cursor-pointer max-[700px]:px-4 active:scale-95 dark:hover:bg-[#1C1C1C]'>
                            {
                                post === "Senin için" ? (
                        ...
                        <NavLink to="/search" className='hover:bg-[#F5F5F5] py-5 px-8 rounded-md my-[4px] mx-[2px] transition-all duration-500 cursor-pointer max-[700px]:px-4 active:scale-95 dark:hover:bg-[#1C1C1C]'>
                        ...
                        <li onClick={handleOpen} className='hover:bg-[#F5F5F5] py-5 px-8 rounded-md my-[4px] mx-[2px] transition-all duration-500 cursor-pointer max-[700px]:px-4 active:scale-95 dark:hover:bg-[#1C1C1C]'>
                        ...
                        <NavLink to="/activity" className='hover:bg-[#F5F5F5] py-5 px-8 rounded-md my-[4px] mx-[2px] transition-all duration-500 cursor-pointer max-[700px]:px-4 active:scale-95 dark:hover:bg-[#1C1C1C]'>
                        ...
                        <NavLink to="/profile" className='hover:bg-[#F5F5F5] py-5 px-8 rounded-md my-[4px] mx-[2px] transition-all duration-500 cursor-pointer max-[700px]:px-4 active:scale-95 dark:hover:bg-[#1C1C1C]'>
            ...
            >
                <Box className='flex flex-col justify-center items-center outline-none' sx={style}>
                    ...
                    <Typography id="modal-modal-description" sx={{ mt: 2 }} className="bg-white dark:bg-[#181818] rounded-2xl flex flex-col w-[618px] max-[755px]:w-[378px] max-[378px]:w-[250px]">
                        <Typography>
                            <div className='flex gap-x-3 text-[15px] text-[#999999] p-6 pb-4'>
                                ...
                                <div className='flex flex-col -mt-[2px] w-full'>
                                    <div className='font-semibold text-black dark:text-white'>alper.iron</div>
                                    <div className='-mt-[2px]'><input type="text" placeholder='Bir yazışma başlat...' className='border-none bg-transparent outline-none text-black dark:text-white w-full' /></div>
                        ...
                        <Typography>
                            <div className='p-6 text-[15px]'>
                                <div className="flex justify-between">
                                    ...
                                    <div>
                                        <button className='px-4 border-[1px] py-1 rounded-lg border-gray-200 border-opacity-20 text-black dark:text-[#777777]'>Paylaş</button>
                                    </div>
                                </div>
                            </div>
                        </Typography>
